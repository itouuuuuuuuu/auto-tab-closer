...
- It stores the following data locally using `chrome.storage`:
  ...
  - The pause toggle, a list of recently auto-closed tabs (URL, title, favicon URL, time closed; capped at 100 entries), and a badge counter in `chrome.storage.local`.
